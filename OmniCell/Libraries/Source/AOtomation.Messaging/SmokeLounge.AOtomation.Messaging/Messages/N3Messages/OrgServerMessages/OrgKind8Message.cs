// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrgKind8Message.cs" company="OmniCell">
...
// </copyright>
// <summary>
//   Defines the OrgKind8Message type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SmokeLounge.AOtomation.Messaging.Messages.N3Messages.OrgServerMessages
{
    ...
    /// </remarks>
    [AoContract((byte)OrgServerMessageType.OrgKind8)]
    public class OrgKind8Message : OrgServerMessage
    {
        #region Constructors and Destructors

        public OrgKind8Message()
        {
            this.OrgServerMessageType = OrgServerMessageType.OrgKind8;
        }
