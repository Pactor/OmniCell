// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrgKind9Message.cs" company="OmniCell">
...
// </copyright>
// <summary>
//   Defines the OrgKind9Message type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SmokeLounge.AOtomation.Messaging.Messages.N3Messages.OrgServerMessages
{
    ...
    /// </remarks>
    [AoContract((byte)OrgServerMessageType.OrgKind9)]
    public class OrgKind9Message : OrgServerMessage
    {
        #region Constructors and Destructors

        public OrgKind9Message()
        {
            this.OrgServerMessageType = OrgServerMessageType.OrgKind9;
        }
