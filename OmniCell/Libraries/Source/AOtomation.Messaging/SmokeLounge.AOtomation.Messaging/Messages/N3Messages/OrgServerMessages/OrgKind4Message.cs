// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrgKind4Message.cs" company="OmniCell">
...
// </copyright>
// <summary>
//   Defines the OrgKind4Message type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SmokeLounge.AOtomation.Messaging.Messages.N3Messages.OrgServerMessages
{
    ...
    /// </remarks>
    [AoContract((byte)OrgServerMessageType.OrgKind4)]
    public class OrgKind4Message : OrgServerMessage
    {
        #region Constructors and Destructors

        public OrgKind4Message()
        {
            this.OrgServerMessageType = OrgServerMessageType.OrgKind4;
        }
