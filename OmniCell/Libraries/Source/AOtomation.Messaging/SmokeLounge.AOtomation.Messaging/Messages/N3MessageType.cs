...
namespace SmokeLounge.AOtomation.Messaging.Messages
{
    public enum N3MessageType
    {
        ...
        CentralControllerState = 0x08536f65,
        ...
        ClientRequestCloseGui = 0x1b3c614d, 

        ClientContainerAddItem = 0x1f4d5f7e, 

        ClientRequestDemolish = 0x3f1b6f70, 

        ClientRqToggleCloaking = 0x3f5e4b46, 

        ClientGetItem = 0x37136c6b, 

        RaidCmd = 0x4e525e58, 

        ClientRequestBuild = 0x53011416, 

        ClientRequestBuy = 0x55796602, 
