            ...
            this.serializers = new Dictionary<Type, ISerializer>
                                   {
                                       ...
                                       {
                                           typeof(PlayfieldDynelRun[]), 
                                           new PlayfieldDynelRunsSerializer()
                                       }, 
                                       {
                                           typeof(ItemStatPair[]), 
                                           new ItemStatPairsSerializer()
                                       }, 
                                       {
                                       ...
                                       {
                                           typeof(CorpseFullUpdateMessage), 
                                           new CorpseFullUpdateSerializer()
                                       },
                                       {
                                           typeof(SpellListMessage), 
                                           new SpellListSerializer()
                                       },
                                       {
                                           typeof(ApplySpellsMessage),
                                           new ApplySpellsSerializer()
                                       },
                                       { typeof(FollowInfo), new FollowInfoSerializer() },
                                       { typeof(NanoEffect), new NanoEffectSerializer() },
                                       {
                                       ...
                                       { typeof(CloneMessage), new CloneSerializer() },
                                       {
                                           typeof(AoTransportSignalMessage),
                                           new AoTransportSignalSerializer()
                                       },
                                       {
                                           typeof(PlayfieldAnarchyFMessage),
                                           new PlayfieldAnarchyFSerializer()
                                       },
                                       {
                                           typeof(N3PlayfieldFullUpdateMessage),
                                           new N3PlayfieldFullUpdateSerializer()
                                       },
                                       {
                                           typeof(GfxTriggerMessage),
                                           new GfxTriggerSerializer()
                                       },
                                       {
                                           typeof(PlayfieldAllCitiesMessage),
                                           new PlayfieldAllCitiesSerializer()
                                       }
                                   };
        }
