...
namespace SmokeLounge.AOtomation.Messaging.Tests
{
    ...
    public class TypeMetaBuilderTest
    {
        ...
        [TestMethod]
        public void PlayfieldAnarchyFMessageWithGeneratorTest()
        {
            var expected = new PlayfieldAnarchyFMessage
                               {
                                   Identity = Identity.None, 
                                   ...
                                   PlayfieldId = Identity.None, 
                                   TemplateGenerator =
                                       new PlayfieldTemplateGeneratorData
                                           {
                                               Identity =
                                                   new Identity { Type = (IdentityType)51069, Instance = 1 }, 
                                               Revision = 1, 
                                               Version = 1, 
